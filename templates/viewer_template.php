...
function getDocumentUrl(document){
    ...
    var url = "services/view.php?doc=" + document + "&format=pdf&subfolder=<?php echo $subfolder; ?>&page=[*,0]," + numPages;
    return url;
}

var searchServiceUrl = "services/containstext.php?doc=<?php echo $doc; ?>&page=[page]&searchterm=[searchterm]";
